...
const locBlock = getBlock(gitContent, "<!-- TAB CONTENT: LOCATIONS -->", "<!-- TAB CONTENT: BLOG -->");
const blogBlock = getBlock(gitContent, "<!-- TAB CONTENT: BLOG -->", "<!-- TAB CONTENT: SERVICES -->");
const servBlock = getBlock(gitContent, "<!-- TAB CONTENT: SERVICES -->", "<!-- TAB CONTENT: PRICING -->");
const priceBlock = getBlock(gitContent, "<!-- TAB CONTENT: PRICING -->", "<!-- TAB CONTENT: PRODUCTS -->");
const prodBlock = getBlock(gitContent, "<!-- TAB CONTENT: PRODUCTS -->", "<!-- TAB CONTENT: ORDERS -->");
...
console.log('Done assembling clean admin index.vue!');
