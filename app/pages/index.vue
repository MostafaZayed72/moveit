    ...
    <section class="relative py-32 px-6 overflow-hidden">
      ...
      <div class="container mx-auto max-w-3xl relative z-10 text-center" data-aos="zoom-in">
        ...
        <div class="flex flex-wrap justify-center gap-4">
          ...
          <a href="https://api.whatsapp.com/send/?phone=31684094271&text&type=phone_number&app_absent=0" target="_blank" class="px-10 py-4 bg-green-500 text-white rounded-full font-bold text-lg shadow-2xl hover:bg-green-600 transition-all active:scale-95 inline-flex items-center gap-2">
