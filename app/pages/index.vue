      ...
      <div class="relative z-10 flex items-center min-h-screen pt-20 px-6">
        <div class="container mx-auto max-w-5xl text-center">
          <div data-aos="zoom-out">
            <div class="inline-flex items-center space-x-2 px-4 py-2 bg-white/5 border border-white/10 rounded-full text-slate-200 text-sm font-semibold mb-8 backdrop-blur-md">
            ...
            <div class="relative h-16 md:h-24 mb-12">
              <Transition name="fade-up" mode="out-in">
                <p :key="currentSubtitle" class="text-xl md:text-3xl text-slate-300 leading-relaxed max-w-3xl mx-auto font-medium drop-shadow-md tracking-tight">
                  {{ currentSubtitle }}
                </p>
              </Transition>
            </div>
            ...
            <div class="flex flex-wrap justify-center gap-6 mt-16">
              ...
              <a href="https://wa.me/31612345678" target="_blank" class="inline-flex items-center gap-3 px-10 py-5 bg-white/10 border border-white/20 text-white rounded-full font-bold backdrop-blur-md hover:bg-white/20 transition-all hover:scale-105 active:scale-95 text-xl shadow-lg">
