    ...
    <div class="w-full max-w-[1440px] mx-auto flex items-center justify-between gap-4">
      ...
      <div class="flex items-center gap-2 sm:gap-3 shrink-0">
        ...
        <div class="hidden xl:flex items-center gap-3.5">
          ...
          <!-- WhatsApp -->
          <a href="https://api.whatsapp.com/send/?phone=31684094271&text&type=phone_number&app_absent=0" target="_blank" class="flex items-center gap-1.5 px-3 py-1.5 bg-green-50 text-green-600 border border-green-200 hover:bg-green-100 dark:bg-green-950/40 dark:text-green-400 dark:border-green-800 dark:hover:bg-green-900/60 rounded-full font-bold text-sm transition-colors shadow-sm">
    ...
    >
      ...
      >
        ...
        <div class="pt-6 border-t border-slate-200 dark:border-slate-800/60 space-y-3">
          ...
          <a 
            href="https://api.whatsapp.com/send/?phone=31684094271&text&type=phone_number&app_absent=0" 
            target="_blank" 
